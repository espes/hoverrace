...
#define RAD_2_MR_ANGLE( pAngle ) ((MR_Angle)( (static_cast<unsigned int>(static_cast<int>(pAngle*static_cast<double>(MR_2PI)*0.5/3.1415926536))+MR_2PI)%static_cast<unsigned int>(MR_2PI) ))
